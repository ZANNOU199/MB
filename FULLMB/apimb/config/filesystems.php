    ...
    */
    ...
    'disks' => [
        ...
        'r2' => [
            ...
            'bucket' => env('CLOUDFLARE_R2_BUCKET_NAME', env('R2_BUCKET_NAME')),
            'url' => env('CLOUDFLARE_R2_PUBLIC_URL', env('R2_PUBLIC_URL')),
            'endpoint' => env('CLOUDFLARE_R2_ENDPOINT', env('R2_ENDPOINT', 'https://'.env('CLOUDFLARE_R2_ACCOUNT_ID', env('R2_ACCOUNT_ID')).'.r2.cloudflarestorage.com')),
            'visibility' => 'public',
